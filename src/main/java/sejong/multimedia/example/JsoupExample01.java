...
public class JsoupExample01 {
  public static void main(String[] args) {
    Document doc;
    try {
      doc = Jsoup.connect("https://www.theguardian.com/science/2018/nov/15/coffee-tea-drink-choice-study-linked-genes-how-we-perceive-bitterness").get();
